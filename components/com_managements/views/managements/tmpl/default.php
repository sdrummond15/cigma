...
<div id="managements" class="row-fluid">
    ...
    <div class="control-group span12" id="head-management">
        ...
        <div class="controls span3">
            <a href="index.php?view=management" class="btn btn-white btn-create">
            ...
            <?php foreach ($this->managements as $management):
                ...
                <tr>
                    ...
                    <td class="edit center" width="10%">
                        <a href="<?php echo JRoute::_('index.php?option=com_managements&view=management&id=' . $management->id); ?>" class="btn btn-white btn-edit">
                            <i class="fa fa-pencil" aria-hidden="true"></i>Prestar Conta
                        </a>
                    </td>
                </tr>
            <?php endforeach; ?>
