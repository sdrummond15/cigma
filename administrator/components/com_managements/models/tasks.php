...
/**
 * Methods supporting a list of tasks.
 *
 * @package  managements
 * @subpackage com_managements
 * @since 2.5
 */
class ManagementsModelTasks extends JModelList
{
    /**
     * Constructor.
     *
    ...
    protected function getListQuery()
    {
        ...
        $query->from($db->quoteName('#__tasks') . ' AS a');

        // Join over the users for the checked out user.
        $query->select('u.name AS consultant');
        $query->join('LEFT', '#__users AS u ON u.id = a.id_consultants');
