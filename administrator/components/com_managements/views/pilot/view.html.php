...
class ManagementsViewPilot extends JViewLegacy
{
    protected $form;
    protected $item;
    protected $state;
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title($isNew ? JText::_('COM_MANAGEMENTS_PILOT_ADD') : JText::_('COM_MANAGEMENTS_PILOT_EDIT'), 'piloto.png');
		...
		JToolBarHelper::help('JHELP_COMPONENTS_MANAGEMENTS_PILOTS_EDIT');
	}
}