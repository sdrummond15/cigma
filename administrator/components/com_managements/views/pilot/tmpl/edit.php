...
<form action="<?php echo JRoute::_('index.php?option=com_managements&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="pilot-form" class="form-validate">
    ...
    <div class="form-horizontal">
        ...
        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details', empty($this->item->id) ? JText::_('COM_MANAGEMENTS_NEW_PILOT', true) : JText::_('COM_MANAGEMENTS_EDIT_PILOT', true)); ?>
        <div class="row-fluid">
            <div class="span9">
