...
<form action="<?php echo JRoute::_('index.php?option=com_managements&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="tax_delivery-form" class="form-validate">
    ...
    <div class="form-horizontal">
        ...
        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details', empty($this->item->id) ? JText::_('COM_MANAGEMENTS_NEW_TAX_DELIVERY', true) : JText::_('COM_MANAGEMENTS_EDIT_TAX_DELIVERY', true)); ?>
        <div class="row-fluid">
            <div class="span9">
