 ...
 * @since  1.6
 */
class ManagementsViewReports_Deliveries extends JViewLegacy
{
    /*
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title(JText::_('COM_MANAGEMENTS_MANAGER_REPORTS_DELIVERIES'), 'reports_deliveries');
        JToolBarHelper::custom('reports', 'report', '',JText::_('COM_MANAGEMENTS_MANAGER_REPORTS_DELIVERIES'), false);
    }
