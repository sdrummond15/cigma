 ...
 * @since  1.6
 */
class ManagementsViewTasks extends JViewLegacy
{
    /**
	 * An array of items
	 *
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title(JText::_('COM_MANAGEMENTS_MANAGER_TASKS'), 'task');
        ...
        if ($this->state->get('filter.state') != -1) {
            ...
            if ($this->state->get('filter.state') != 2) {
                ...
                JToolBarHelper::unarchiveList('tasks.publish');
            }
        }
        ...
        JToolbarHelper::help('JHELP_COMPONENTS_MANAGEMENTS_TASKS');
    }
